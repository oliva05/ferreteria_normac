...
{
    public partial class frmVerStockPorAlmacen : DevExpress.XtraEditors.XtraForm
    {
        int IdPT;
        decimal CantidadReq;
        ...
        public frmVerStockPorAlmacen(int pIdPt, string ProductoName, decimal pCantidarReq, ArrayList pListaActual,
                                            ...
                                            string itemname, decimal itemIsv1, decimal pDescuentoPorcentaje, bool pIsUsados)
        {
            ...
            gridView1.OptionsMenu.EnableColumnMenu = false;//Habilita o deshabilita que el user pueda manipular
