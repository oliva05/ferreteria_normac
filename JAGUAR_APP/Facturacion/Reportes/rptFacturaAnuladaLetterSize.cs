...
{
    public partial class rptFacturaAnuladaLetterSize : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public rptFacturaAnuladaLetterSize(Factura Factura1, TipoCopia pTipoCopia)
        {
            InitializeComponent();
        ...
        private void rptFacturaAnuladaLetterSize_BeforePrint(object sender, CancelEventArgs e)
        {
        }
        private void rptFacturaAnuladaLetterSize_DataSourceDemanded(object sender, EventArgs e)
        {
        }
