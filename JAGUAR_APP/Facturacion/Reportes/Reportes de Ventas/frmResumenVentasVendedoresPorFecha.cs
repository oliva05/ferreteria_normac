...
{
    public partial class frmResumenVentasVendedoresPorFecha : DevExpress.XtraEditors.XtraForm
    {
        DataOperations dp;
        UserLogin UsuarioLogeado;
        public frmResumenVentasVendedoresPorFecha(UserLogin pUsuario)
        {
            InitializeComponent();
        ...
        private void LoadDatos()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("[dbo].[sp_get_resumen_ventas_vendedores_by_rango_fechas]", con);
