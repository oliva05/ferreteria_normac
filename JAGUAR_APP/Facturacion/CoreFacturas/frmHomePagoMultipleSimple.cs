    ...
    public partial class frmHomePagoMultipleSimple : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void gvFacturas_CellValueChanging(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            switch (e.Column.FieldName)
            {
                case "seleccionado":
                    ...
                    //checkDisponibles.CheckedChanged += new EventHandler(checkDisponibles_CheckedChanged);
                    gvFacturas.CellValueChanging -= new DevExpress.XtraGrid.Views.Base.CellValueChangedEventHandler(gvFacturas_CellValueChanging);
        ...
        private void cmdAnular_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            try
            {
                ...
                frmNavigationPageAutorizacion authorize = 
                    new frmNavigationPageAutorizacion(solicitud, this.PuntoDeVentaActual, frmNavigationPageAutorizacion.TipoDocumentoOrigen.Recibo);
