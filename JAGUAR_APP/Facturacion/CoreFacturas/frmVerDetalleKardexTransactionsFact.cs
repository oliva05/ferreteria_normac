...
namespace JAGUAR_PRO.Reportes
{
    public partial class frmVerDetalleKardexTransactionsFact : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmVerDetalleKardexTransactionsFact(int pIdPT, string pName, decimal pInv, int pPuntoVentaId)
        {
            InitializeComponent();
            NamePT = pName;
            InvActual = pInv;
        ...
        private void LoadDatos(int pIdPT)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("dbo.[sp_get_detalle_transacciones_kardex_pt_from_idpt_for_facturacion]", con);
