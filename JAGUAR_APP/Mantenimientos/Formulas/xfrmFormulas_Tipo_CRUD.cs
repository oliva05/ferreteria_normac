...
namespace JAGUAR_APP.Mantenimientos.Formulas
{
    public partial class xfrmFormulas_Tipo_CRUD : DevExpress.XtraEditors.XtraForm
    {
       ...
       public enum TipoTransaccion
        ...
        public xfrmFormulas_Tipo_CRUD(int TipoTransaccionP,int PId, string pDescripcion)
        {
            InitializeComponent();
                ...
                switch (tipoTransacion)
                {
                    case (int)TipoTransaccion.Nuevo:
                        ...
                        using (SqlConnection cnx = new SqlConnection(dp.ConnectionStringJAGUAR_DB))
                        {
                            ...
                            SqlCommand cmd = new SqlCommand("dbo.usp_insertNewTipoFormula", cnx);
                    ...
                    case (int)TipoTransaccion.Editar:
                        ...
                        using (SqlConnection cnx2 = new SqlConnection(dp2.ConnectionStringJAGUAR_DB))
                        {
                            ...
                            SqlCommand cmd2 = new SqlCommand("dbo.usp_UpdateTipoFormula", cnx2);
