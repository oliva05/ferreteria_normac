...
namespace JAGUAR_APP.Mantenimientos.MateriaPrima
{
    public partial class xfrmMateriasPrimas_Tipo_CRUD : DevExpress.XtraEditors.XtraForm
    {
        ...
        public delegate void get_tipo_inserted(int Id_lata_inserted);
        ...
        public xfrmMateriasPrimas_Tipo_CRUD(int TipoTransaccionP,int PId, string pDescripcion)
        {
            InitializeComponent();
        ...
        private void cmdNew_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    CajaDialogo.Error("DEBE DE INGRESAR UN TIPO DE MATERIA PRIMA");
                    return;
                }
                ...
                switch (tipoTransacion)
                {
                    case (int)TipoTransaccion.Nuevo:
                        ...
                        using (SqlConnection cnx = new SqlConnection(dp.ConnectionStringJAGUAR_DB))
                        {
                            ...
                            SqlCommand cmd = new SqlCommand("dbo.usp_insertNewTipoMP_V2", cnx);
                    ...
                    case (int)TipoTransaccion.Editar:
                        ...
                        using (SqlConnection cnx2 = new SqlConnection(dp2.ConnectionStringJAGUAR_DB))
                        {
                            ...
                            SqlCommand cmd2 = new SqlCommand("dbo.usp_UpdateTipoMP", cnx2);
