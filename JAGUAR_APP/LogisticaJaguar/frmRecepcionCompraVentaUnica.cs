    ...
    public partial class frmRecepcionCompraVentaUnica : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void LoadaData()
        {
            try
            {
                ...
                cmd = new SqlCommand("[sp_get_pt_load_ingresos_venta_unica_inv]", conn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Clear();
                //cmd.Parameters.AddWithValue("@desde", dtDesde.DateTime);
                //cmd.Parameters.AddWithValue("@hasta", dtHasta.DateTime);
                adat = new SqlDataAdapter(cmd);
                dsPT_USADOS1.ingreso_pt_venta_unicaINV.Clear();
                adat.Fill(dsPT_USADOS1.ingreso_pt_venta_unicaINV);
        ...
        private void cmdPrintCode_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            var gridview = (GridView)grdInventarioDisponible.FocusedView;
            var row = (dsPT_USADOS.ingreso_pt_venta_unicaINVRow)gridview.GetFocusedDataRow();
        ...
        private void cmdEdit_inv_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            var gridview = (GridView)grdInventarioDisponible.FocusedView;
            var row = (dsPT_USADOS.ingreso_pt_venta_unicaINVRow)gridview.GetFocusedDataRow();
        ...
        private void cmdDeleteRow_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            DialogResult r = CajaDialogo.Pregunta("Desea eliminar este producto usado.");
            if (r != System.Windows.Forms.DialogResult.Yes)
                return;
