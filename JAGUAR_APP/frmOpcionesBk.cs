...
//using JAGUAR_PRO.Trazabilidad.ReportesTRZ;
using System;
using System.Data;
...
{
    public partial class frmOpcionesBk : Form
    {
        ...
        public frmOpcionesBk(UserLogin pUser)
        {
            InitializeComponent();
        ...
        private void frmOpcionesBk_Load(object sender, EventArgs e)
        {
            try
            {
                bool newVersion;
