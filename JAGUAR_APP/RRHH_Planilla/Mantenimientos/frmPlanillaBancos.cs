...
{
    public partial class frmPlanillaBancos : DevExpress.XtraEditors.XtraForm
    {
        ...
        int banco_id;
        public frmPlanillaBancos(TipoTransaccionPlanilla transact,UserLogin user_p)
        {
            InitializeComponent();
        ...
        public frmPlanillaBancos(TipoTransaccionPlanilla transact, int id_departamento, UserLogin user_p)
        {
            InitializeComponent();
            transaccion_tipo = transact;
