...
{
    public partial class frmPlanillaDepartmentHome : DevExpress.XtraEditors.XtraForm
    {
        UserLogin usuarioLog;
        public frmPlanillaDepartmentHome(UserLogin user)
        {
            InitializeComponent();
            usuarioLog = user;
            CargarDatos();
        ...
        private void btnDelete_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("dbo.uspDeshabilitarDepartment", cnx))
                {
                    cnx.Open();
