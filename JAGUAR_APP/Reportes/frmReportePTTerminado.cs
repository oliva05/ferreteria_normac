...
{
    public partial class frmReportePTTerminado : DevExpress.XtraEditors.XtraForm
    {
        public frmReportePTTerminado()
        {
            InitializeComponent();
        }
      ...
      private void  load_data()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("dbo.usp_rpt_ProductoTerminado", cnx))
            {
                ...
                cnx.Open();
                dsReportes.rptPTDiario.Clear();
                da.Fill(dsReportes.rptPTDiario);
                cnx.Close();
            }
        ...
        private void cmdExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    gcReportePT.ExportToXlsx(path, advOptions);
