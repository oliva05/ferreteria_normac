...
{
    public partial class frmAddAvanceProduccionBolsasDanadas : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmAddAvanceProduccionBolsasDanadas(UserLogin pUsuarioLogeado, Int64 pIdOrdenFabricacion)
        {
            InitializeComponent();
            CantidadIngresada = 0;
        ...
        public frmAddAvanceProduccionBolsasDanadas(UserLogin pUsuarioLogeado, Int64 pIdOrdenFabricacion, TipoAccion pTipoAccion)
        {
            InitializeComponent();
            ItemSeleccionado = new ItemS();
            UsuarioLogeado = pUsuarioLogeado;
        ...
        private void cmdAplicarCambios_Click(object sender, EventArgs e)
        {
            ...
            decimal cantidadRecibidaBolsasPT = 0;
            ...
            foreach (dsLogisticaJaguar.Home_Production_ordersRow row1 in dsLogisticaJaguar1.Home_Production_orders)
            {
                if (row1.seleccionado)
                {
                    ...
                    cantidadRecibidaBolsasPT = row1.cant_bolsas_real;
                    break;
                }
            }

            if (CantidadIngresada > cantidadRecibidaBolsasPT)
            {
                CajaDialogo.Error("Debe ingresar una cantidad menor o igual a la cantidad valida de bolsas ingresadas al sistema!");
                return;
            }
            ...
            try
            {
                ...
                string query = "[codesahn].[sp_set_insert_avance_produccion_revision_bolsas_danadas]";
