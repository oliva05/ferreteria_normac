...
{
    public partial class frmAddAvanceProduccionBolsas : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmAddAvanceProduccionBolsas(UserLogin pUsuarioLogeado, Int64 pIdOrdenFabricacion)
        {
            InitializeComponent();
            CantidadIngresada = 0;
        ...
        public frmAddAvanceProduccionBolsas(UserLogin pUsuarioLogeado, Int64 pIdOrdenFabricacion, TipoAccion pTipoAccion)
        {
            InitializeComponent();
            ItemSeleccionado = new ItemS();
            UsuarioLogeado = pUsuarioLogeado;
